...
public class HromiakSortingAdditionalTests {
    ...
    public void captnCrunchOopsAllNegatives() {
        int[] unsortedArray = new int[] {-30, -45, Integer.MAX_VALUE, -14056, -33, -1};
        int[] sortedArray = new int[] {-14056, -45, -33, -30, -1, Integer.MAX_VALUE};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
    ...
    public void testLSDRadixMinValue() {
        int[] unsortedArray = new int[] {Integer.MIN_VALUE, 28, 58, -840, 20, -54, 85, 3};
        int[] sortedArray = new int[] {Integer.MIN_VALUE, -840, -54, 3, 20, 28, 58, 85};
        Sorting.lsdRadixSort(unsortedArray);
        assertArrayEquals(sortedArray, unsortedArray);
    }
