...
public class SSTests {
    ...
    @Test(timeout = TIMEOUT)
    public void t45additionalTest() {
        // removing node with 2 children requiring double rebalancing
        // left rotation then right rotation
        // this is the mirror case for test 38
        Integer[] args = new Integer[] {1, 32, 4, 100, 97, 14, 15, 82, 83, 86, 22, 99, 56, 62, 94};
        avlTree = new AVL<>(Arrays.asList(args));
        /*
         *             9
         *            / \
        ...
        assertEquals(1, (int) avlTree.remove(1));
        assertEquals(32, (int) avlTree.remove(32));
        assertEquals(4, (int) avlTree.remove(4));
        assertEquals(100, (int) avlTree.remove(100));
        assertEquals(97, (int) avlTree.remove(97));
        assertEquals(14, (int) avlTree.remove(14));
        //assertEquals(15, (int) avlTree.remove(15));
        //assertEquals(82, (int) avlTree.remove(82));
        //assertEquals(83, (int) avlTree.remove(83));
        //assertEquals(86, (int) avlTree.remove(86));
        pos      = new     int[] {1, 2,  3, 4, 5,  7};
        vals     = new Integer[] {6, 4, 10, 2, 5, 11};
        heights  = new     int[] {2, 1,  1, 0, 0,  0};
        balances = new     int[] {0, 0, -1, 0, 0,  0};
